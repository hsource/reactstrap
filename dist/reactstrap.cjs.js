...
function (_React$Component) {
  ...
  _proto.renderChildren = function renderChildren() {
    ...
    var popperClassName = mapToCssModules(classNames(_popperClassName, placementPrefix ? placementPrefix + "-" + placement : placement), this.props.cssModule);
    ...
    return React__default.createElement(Fade, _extends({}, popperTransition, attrs, {
      ...
      placement: this.state.placement || attrs.placement
...
function (_React$Component) {
  ...
  function Modal(props) {
    ...
    _this.onClosed = _this.onClosed.bind(_assertThisInitialized(_assertThisInitialized(_this)));
    _this.manageFocusAfterClose = _this.manageFocusAfterClose.bind(_assertThisInitialized(_assertThisInitialized(_this)));
    _this.state = {
      isOpen: props.isOpen
    };
...
var propTypes$14 = _extends({}, reactTransitionGroup.Transition.propTypes, {
  isOpen: PropTypes.bool,
  children: PropTypes.oneOfType([PropTypes.arrayOf(PropTypes.node), PropTypes.node]),
  tag: tagPropType,
