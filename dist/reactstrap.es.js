...
function (_React$Component) {
  ...
  _proto.render = function render() {
    ...
    if (persist || this.context.isOpen && !this.context.inNavbar) {
      ...
      var useContainer = container !== 'inline' && this.context.dropdownElement;
      var referenceElement = useContainer ? this.context.dropdownElement : undefined;
...
var propTypes$15 = _extends({}, Transition.propTypes, {
  isOpen: PropTypes.bool,
  children: PropTypes.oneOfType([PropTypes.arrayOf(PropTypes.node), PropTypes.node]),
  tag: tagPropType,
...
var defaultProps$11 = _extends({}, Transition.defaultProps, {
  isOpen: false,
  appear: false,
  enter: true,
  exit: true,
