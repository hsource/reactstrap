...
function (_React$Component) {
  ...
  _proto.renderChildren = function renderChildren() {
    ...
    var popperClassName = (0, _utils.mapToCssModules)((0, _classnames.default)(_popperClassName, placementPrefix ? placementPrefix + "-" + placement : placement), this.props.cssModule);
