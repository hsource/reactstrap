...
var propTypes = {
  ...
  menuContainer: _utils.targetPropType
};
var defaultProps = {
  isOpen: false,
  direction: 'down',
...
function (_React$Component) {
  ...
  _proto.getContainer = function getContainer() {
    if (this.props.menuContainer) {
      return (0, _utils.getTarget)(this.props.menuContainer);
    }
  ...
  _proto.render = function render() {
    ...
    var _omit = (0, _utils.omit)(this.props, ['toggle', 'disabled', 'inNavbar', 'menuContainer']),
